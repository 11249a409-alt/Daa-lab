AIM
To write a C program to analyze the time required to perform binary search on a sorted array of 10000 randomly generated numbers using the clock() function.
...
8. Stop the timer
9. Calculate time using end - start
